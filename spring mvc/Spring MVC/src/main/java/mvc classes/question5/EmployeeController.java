...
public class EmployeeController {
	...
	public ModelAndView home() {
		return new ModelAndView("question5/Home");
	}
	...
	public ModelAndView add() {
		return new ModelAndView("question5/AddEmployee");
	}
	
	@RequestMapping(value="/edit/{id}")
	public ModelAndView edit(@PathVariable("id") int id) {
		
		ModelAndView mav= new ModelAndView("question5/Update");
	...
	public ModelAndView delete(@PathVariable("id") int id) {
		employees.remove(id);
		ModelAndView mav= new ModelAndView("question5/Display");
		mav.addObject("list", employees.values());
		return mav;
	}
